...
public class LoginFailedTest {
	...
	public void openLogin() {
		...
		WebElement cursor = webDriver.findElement(By.cssSelector(
		...
		cursor = webDriver.findElement(By.cssSelector(
		...
		assertEquals(cursor.getText(), "**Failed Login**");
	}
